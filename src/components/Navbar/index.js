...
const Navbar = () => {
  return (
    <nav className="px-4 fixed bottom-0 flex justify-between h-12 items-center w-screen md:top-0 mt-24 md:grid md:h-56 md:max-w-sm mx-auto text-sm md:text-base font-light text-green-500 md:w-64 md:shadow-md md:rounded-lg bg-white z-10">
